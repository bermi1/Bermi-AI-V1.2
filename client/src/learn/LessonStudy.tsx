...
import { ArrowLeft, Award, Brain, CheckCircle2, RotateCcw, Sparkles } from 'lucide-react'
      ...
      {phase === 'read' && (
        <>
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3">
            <Btn onClick={startQuiz} loading={quizLoading}>
              <Brain size={17} /> Test my understanding
            </Btn>
            <Btn variant="outline" onClick={() => finish()} loading={saving} disabled={done}>
              <CheckCircle2 size={16} /> {done ? 'Marked complete' : 'Mark complete'}
            </Btn>
          </div>
          <p className="mt-3 text-[12px] text-ink-faint">
            <Sparkles size={12} className="mr-1 inline" /> The quiz is generated by Bermi from this lesson — your score is
            recorded and averaged into your course grade.
          </p>
        </>
      )}
